...
public class JavaParser implements JavaParserConstants {
  ...
  ArrayList < Collector > Classes = new ArrayList < Collector > ();
  Stack<Collector> stackCollector = new Stack<Collector>();
  Collector a;

  public int afficherPublic()
  {
    return a.getNb_public();
  }

  public int afficherProtected()
  {
    return a.getNb_protected();
  }

  public int afficherNbClasses()
  {
    return Classes.size();
  }

  public String afficherNomClasses()
  {
    return a.getNomClasse();
  }
  ...
  {
    JavaParser parser;
    menuInterfaces menu = new menuInterfaces();

    final  String espaceEntreMenus = "\u005cn\u005cn\u005cn";
    ...
    {
      String choice = menu.afficherDossier(args [0]);
     // System.out.println("Java Parser Version 1.7:  Reading from file " + args [0] + "...");      try
      {
        String toRead = args [0] + "/" + choice;
        parser = new JavaParser(new java.io.FileInputStream(toRead));
      }
      catch (java.io.FileNotFoundException e)
      {
        System.out.println("Java Parser Version 1.7:  File " + choice + " not found.");
        return;
      }
    }
    else
    ...
    try
    {
      ...
      System.out.println("Nombre de classe total : " + parser.afficherNbClasses());
      int choix = -1;

      do {
                        //Menu                        choix = menuInterfaces.menuPrincipale();
                        switch (choix) {

                        case 1:
                                int classeChoix = menu.listeClasses(parser.Classes);
                                Collector nomClasse = parser.Classes.get(classeChoix -1);
                                menu.numero1(nomClasse);
                                break;
                        case 2:
                                                                classeChoix = menu.listeClasses(parser.Classes);
                                                                nomClasse = parser.Classes.get(classeChoix -1);
                                                                menu.numero2(nomClasse);
                                break;
                        case 3:
                                        classeChoix = menu.listeClasses(parser.Classes);
                                                                nomClasse = parser.Classes.get(classeChoix -1);
                                                                menu.numero3(nomClasse);
                                break;
                        case 4:
                                                                classeChoix = menu.listeClasses(parser.Classes);
                                                                nomClasse = parser.Classes.get(classeChoix -1);
...
//modifiers attributs ou methodes, classes, interface - Dom  final public String Modifiers() throws ParseException {
  String type;
    type = "";
    label_3:
    while (true) {
...
// Handle classes, interfaces, enums, and annotations.  final public void TypeDeclaration() throws ParseException {
  ...
  Token nom;
    ...
    //Dom : instanciation d'une nouvelle classe
      nom = jj_consume_token(IDENTIFIER);
    a = new Collector(nom.toString());
    Classes.add(a);
    stackCollector.push(a);
    a = stackCollector.peek();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LT:
      TypeParameters();
      break;
  ...
  final public void ExtendsList() throws ParseException {
        ...
        String multipleHeritage = null;
    jj_consume_token(EXTENDS);
    heritage = ClassOrInterfaceType();
    a.setHasHeritage(true);
    a.setHeriteFrom(heritage);
    label_4:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
      ...
      multipleHeritage = ClassOrInterfaceType();
      a.setHasHeritageMultiple(true);
      a.setHeriteFrom(multipleHeritage + ",");
    }
  }
  ...
  String inter = null;
    ...
    inter = ClassOrInterfaceType();
    a.setHasInterface(true);
    a.setInterface(inter+",");
    label_5:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
  ...
  String type;
    if (jj_2_10(2)) {
      ...
      case LT:
        ...
        a.stackAttributsModifiers.push(type);
        switch (type)
        {
          case "public" : a.setNb_public();
          break;
          case "private" : a.setNb_private();
          break;
          case "protected" : a.setNb_protected();
          break;
          default : a.setNb_attribut();
          break;
        }
              FieldDeclaration();
            } else if (jj_2_9(2)) {
  ...
  Token name2 = null;
    ...
    while (true) {
      ...
      jj_consume_token(COMMA);
      name2 = VariableDeclarator();
                if(t != null && name2.toString() != null) {
        a.Type.add(t);
        switch (a.stackAttributsModifiers.peek())
        {
          case "public" : a.setNb_public();
          break;
          case "private" : a.setNb_private();
        ...
        a.ajoutTypePrimitif();
                ...
                if(!a.typePrimitif.contains(t)) {
                        a.map.put(name2.toString(),t);

                }
                else
                {
                  a.typeNomMap.put(name2.toString(),t);
                }

      }
    }
      if(t != null && name.toString() != null) {
        a.Type.add(t);

        a.ajoutTypePrimitif();

                if(!a.typePrimitif.contains(t)) {
                        a.map.put(name.toString(),t);

                }
                else
                {
                  a.typeNomMap.put(name.toString(),t);
                }

      }
    jj_consume_token(SEMICOLON);
      if(!a.stackAttributsModifiers.empty())
                        a.stackAttributsModifiers.pop();
  }

  final public Token VariableDeclarator() throws ParseException {
        Token name = null;
...
Token methodName = null;
    ...
    default:
      ...
      ;
                ...
                a.stackMethod.push(methodName.toString());
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LBRACE:
      Block();
      break;
  ...
  Token reference = null;
    reference = jj_consume_token(IDENTIFIER);
    if (jj_2_19(2)) {
      TypeArguments();
    } else {
      ;
    ...
    {if (true) return reference.toString();}
    throw new Error("Missing return statement in function");
  }
...
//Getting method declaration from other classes  final public void Name() throws ParseException {
  Token asso = null;
  Token method = null;
    asso = jj_consume_token(IDENTIFIER);
        if(a!=null)
                if(!a.map.containsKey(asso.toString()))
                {
                                a.instanceDeClasseList.add(asso.toString());
                        a.instanceDeClasse.put(asso.toString(),"Classe");
                }
                                //a.assoRecurrency.add(asso.toString());*/
    ...
    while (true) {
      ...
      if(a!=null) {
                method met = a.new method(method.toString(),asso.toString(),a.stackMethod.peek());
        a.listMethod.add(met);
      }
    }
  }
...
Token name = null;
    ...
    reference = Type();
    name = VariableDeclarator();
    a.stackAsso.push(reference);
    a.ajoutTypePrimitif();
    if(!a.typePrimitif.contains(reference))
        a.map.put(name.toString(),reference);
    label_39:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
